    ...
    return (
        <Dialog open={open} onOpenChange={onClose}>
            <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
                ...
                >
                    <DialogHeader>
                        <DialogTitle className="text-2xl">Pathfinding Algorithms</DialogTitle>
                    </DialogHeader>
                    ...
                    <div className="space-y-6 text-sm mt-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="bg-muted/50 p-3 rounded-md space-y-1">
                                <p><strong>Guarantees:</strong> ✅ Shortest path</p>
                                <p><strong>Time Complexity:</strong> O(V + E)</p>
                                <p><strong>Space Complexity:</strong> O(V)</p>
                                <p><strong>Best for:</strong> Unweighted graphs, finding shortest path</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="bg-muted/50 p-3 rounded-md space-y-1">
                                <p><strong>Guarantees:</strong> ❌ May not find shortest path</p>
                                <p><strong>Time Complexity:</strong> O(V + E)</p>
                                <p><strong>Space Complexity:</strong> O(V)</p>
                                <p><strong>Best for:</strong> Exploring all paths, maze generation, topological sorting</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="bg-muted/50 p-3 rounded-md space-y-1">
                                ...
                                <p><strong>Time Complexity:</strong> O(E) with good heuristic</p>
                                <p><strong>Space Complexity:</strong> O(V)</p>
                                <p><strong>Best for:</strong> Pathfinding with obstacles, game AI, navigation systems</p>
                                <p><strong>Heuristic:</strong> Manhattan distance (perfect for grid-based movement)</p>
                            </div>
                        </div>
